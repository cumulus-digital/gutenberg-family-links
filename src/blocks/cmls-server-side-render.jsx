...
export default function CmlsServerSideRender( props ) {
	...
	const debouncedFetchData = useDebounce( fetchData, 100, { leading: true, trailing: true } );
	...
	const MySpinner = props.LoadingResponsePlaceholder ? props.LoadingResponsePlaceholder : (<Spinner />);
